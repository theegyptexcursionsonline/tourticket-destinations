...
const tenantConfig = {
  ...
  branding: {
    logo: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-logo.png',
  ...
  seo: {
    ...
    ogImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-og.jpg',
  },
  contact: {
...
const destinations = [
  {
    ...
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/hurghada-destination.jpg',
    images: [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/giftun-island.jpg',
    images: [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/orange-bay.jpg',
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/dolphin-house.jpg',
    highlights: [
...
const categories = [
  {
    ...
    icon: '🚤',
    color: '#00CED1',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-category.jpg',
  ...
  },
  {
    ...
    icon: '🤿',
    color: '#20B2AA',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/snorkeling-category.jpg',
  ...
  },
  {
    ...
    icon: '🏝️',
    color: '#FFD700',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/island-category.jpg',
  ...
  },
  {
    ...
    icon: '🐬',
    color: '#4169E1',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/dolphin-category.jpg',
  ...
  },
  {
    ...
    icon: '🌅',
    color: '#FF6347',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/sunset-category.jpg',
  ...
  },
  {
    ...
    icon: '⛵',
    color: '#9370DB',
    heroImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/private-category.jpg',
...
This tour is perfect for families, couples, and anyone seeking the perfect blend of adventure and relaxation.`,
    ...
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/giftun-speedboat-tour.jpg',
    images: [
...
Our tour includes a delicious gourmet lunch at the island's restaurant, giving you a taste of international and local cuisine while overlooking the stunning sea views.`,
    ...
    maxGroupSize: 30,
    location: 'Hurghada Marina',
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/orange-bay-tour.jpg',
    images: [
...
Note: Dolphin sightings are highly likely but cannot be 100% guaranteed as these are wild animals.`,
    ...
    maxGroupSize: 15,
    location: 'Hurghada Marina',
    image: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/dolphin-tour.jpg',
    images: [
...
const heroSettings = {
  ...
  backgroundImages: [
    {
      desktop: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-hero-1.jpg',
    ...
    {
      desktop: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-hero-2.jpg',
      alt: 'Snorkeling in crystal clear waters',
      isActive: false,
    },
    {
      desktop: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-hero-3.jpg',
      alt: 'Giftun Island paradise beach',
      isActive: false,
    },
  ],
  currentActiveImage: 'https://res.cloudinary.com/dvcfefmys/image/upload/v1734100000/speedboat-hero-1.jpg',
  title: {
    main: 'Red Sea',
