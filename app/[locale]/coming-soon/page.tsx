...
export default function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 start-10 w-20 h-20 rounded-full opacity-20 animate-pulse" style={{ backgroundColor: primaryColor }} />
      <div className="absolute bottom-20 end-10 w-32 h-32 rounded-full opacity-10 animate-pulse delay-1000" style={{ backgroundColor: primaryColor }} />
      <div className="absolute top-1/3 end-1/4 w-16 h-16 rounded-full opacity-15 animate-bounce" style={{ backgroundColor: primaryColor }} />
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  required
                  className="w-full ps-12 pe-4 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all"
