      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full ps-10 pe-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent"
          />
        </div>
              ...
              <div className="p-4">
                ...
                {offer.code && (
                  ...
                  >
                    ...
                    <Copy className="w-4 h-4 text-slate-400 ms-auto" />
                  </div>
                )}
