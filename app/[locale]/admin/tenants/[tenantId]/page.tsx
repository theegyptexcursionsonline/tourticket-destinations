        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            >
              ...
              {tenant.websiteStatus === status.value && (
                <CheckCircle2 className={`absolute top-3 end-3 w-5 h-5 ${
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
            <label className="block text-sm font-semibold text-slate-700 mb-1">Google Tag Manager ID</label>
            <input
              type="text"
              value={tenant.seo?.googleTagManagerId || ''}
              onChange={(e) => updateField('seo.googleTagManagerId', e.target.value)}
              placeholder="GTM-XXXXXXX"
              className={UI.input}
            />
            <p className="text-xs text-slate-500 mt-2">Tenant-specific GTM container ID. AdRoll and other tags are managed inside GTM.</p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
            ...
            <input
              type="text"
              value={tenant.seo?.googleAnalyticsId || ''}
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
          <label className="block text-sm font-semibold text-slate-700 mb-1">
            <Mail className="w-4 h-4 inline me-1" /> Email
          </label>
          <input
            type="email"
        ...
        <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
          <label className="block text-sm font-semibold text-slate-700 mb-1">
            <Phone className="w-4 h-4 inline me-1" /> Phone
          </label>
          <input
            type="tel"
      ...
      <div className="grid grid-cols-1 gap-4">
        {socialFields.map(({ key, label, icon: Icon, placeholder }) => (
          <div key={key} className="rounded-3xl border border-slate-200 bg-slate-50/60 p-5">
            <label className="block text-sm font-semibold text-slate-700 mb-1">
              <Icon className="w-4 h-4 inline me-1" /> {label}
            </label>
            <input
              type="url"
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-6">
        ...
        {isLoadingTours ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-h-96 overflow-y-auto pe-1">
            {tours.map((tour) => {
              ...
              return (
                <button
                  ...
                  className={`text-start p-3 rounded-2xl border transition-all ${
                    isSelected 
