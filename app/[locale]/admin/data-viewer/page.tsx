        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full ps-10 pe-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
            />
          </div>
        ...
        {items.length === 0 ? (
          ...
          items.map((item: any) => (
            <div key={item._id} className="border border-gray-200 rounded-lg">
              ...
              >
                <span className="font-medium text-start">{item.title || item.name}</span>
