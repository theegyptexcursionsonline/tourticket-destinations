...
function ModernHero() {
  ...
  return (
    <div className="relative h-[600px] bg-gradient-to-br from-slate-950 via-slate-900 to-red-950 flex items-center justify-center text-white text-center px-4 overflow-hidden">
      ...
      <div className="absolute top-20 start-10 w-96 h-96 bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 end-10 w-[500px] h-[500px] bg-gradient-to-r from-blue-500/15 to-cyan-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 start-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      >
        ...
        >
          <span className="px-6 py-2.5 bg-gradient-to-r from-red-600/30 to-orange-600/30 border border-red-400/40 rounded-full text-sm font-semibold backdrop-blur-md shadow-lg shadow-red-500/20">
            <span className="inline-block w-2 h-2 bg-green-400 rounded-full me-2 animate-pulse"></span>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>{t('contact.verifiedSecure')}</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all border border-white/20 overflow-hidden">
                ...
                <div className="relative flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">{t('contact.callUs')}</h3>
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-slate-600 bg-slate-100 px-3 py-1.5 rounded-full">
                    ...
                    <span className="font-medium">{t('contact.available247')}</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all border border-white/20 overflow-hidden">
                ...
                <div className="relative flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">{t('contact.emailUs')}</h3>
                  <a
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all border border-white/20 overflow-hidden">
                ...
                <div className="relative flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">{t('contact.chatWithUs')}</h3>
                  <p className="text-green-600 font-bold text-lg mb-3">{t('contact.chatWithUs')}</p>
                  <div className="flex items-center gap-1.5 text-xs text-slate-600 bg-slate-100 px-3 py-1.5 rounded-full">
                    <span className="inline-block w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                    <span className="font-medium">{t('contact.instantSupport')}</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            >
              <div className="relative bg-gradient-to-br from-white via-white to-red-50/30 rounded-3xl shadow-2xl p-8 lg:p-12 border border-white/60 overflow-hidden">
                ...
                <div className="absolute top-0 end-0 w-64 h-64 bg-gradient-to-br from-red-100/40 to-orange-100/40 rounded-full blur-3xl -z-0" />
                <div className="absolute bottom-0 start-0 w-64 h-64 bg-gradient-to-br from-blue-100/40 to-purple-100/40 rounded-full blur-3xl -z-0" />
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-10">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-600 font-medium">{t('contact.sentDescription')}</p>
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        <div className="flex items-center gap-1.5 bg-green-50 border border-green-200 px-3 py-1.5 rounded-full">
                          ...
                          <span className="text-xs font-semibold text-green-700">{t('contact.secureProtected')}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 pt-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3 text-xs">
                      <div className="flex items-center gap-1.5 text-green-600">
                        ...
                        <span className="font-semibold">{t('contact.sslEncrypted')}</span>
                      </div>
                      ...
                      <div className="flex items-center gap-1.5 text-blue-600">
                        ...
                        <span className="font-semibold">{t('contact.spamProtected')}</span>
                      </div>
                      <span className="text-slate-300">•</span>
                      <div className="flex items-center gap-1.5 text-purple-600">
                        ...
                        <span className="font-semibold">{t('contact.gdprCompliant')}</span>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-slate-950 via-slate-900 to-red-950 rounded-3xl p-8 text-white shadow-2xl overflow-hidden border border-white/10">
                {/* Decorative glow */}
                <div className="absolute top-0 end-0 w-48 h-48 bg-red-500/20 rounded-full blur-3xl" />
                <div className="absolute bottom-0 start-0 w-48 h-48 bg-blue-500/10 rounded-full blur-3xl" />
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <h3 className="font-black text-xl">{t('contact.officeHours')}</h3>
                  </div>
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="flex justify-between items-center py-3 border-b border-white/10 group hover:border-red-400/30 transition-colors">
                      <span className="text-slate-400 group-hover:text-slate-300 transition-colors">{t('contact.mondayFriday')}</span>
                      <span className="font-bold text-white">9:00 AM - 6:00 PM</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-white/10 group hover:border-red-400/30 transition-colors">
                      <span className="text-slate-400 group-hover:text-slate-300 transition-colors">{t('contact.saturday')}</span>
                      <span className="font-bold text-white">10:00 AM - 4:00 PM</span>
                    </div>
                    <div className="flex justify-between items-center py-3 group">
                      <span className="text-slate-400 group-hover:text-slate-300 transition-colors">{t('contact.sunday')}</span>
                      <span className="font-bold text-red-400">{t('contact.closed')}</span>
                    </div>
                  </div>
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/60 overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="font-black text-xl text-slate-900">{t('contact.visitUs')}</h3>
                  </div>
              ...
              <div className="relative bg-gradient-to-br from-white via-white to-purple-50/30 rounded-3xl p-8 shadow-2xl border border-white/60 overflow-hidden">
                {/* Decorative element */}
                <div className="absolute top-0 end-0 w-32 h-32 bg-gradient-to-br from-purple-200/30 to-pink-200/30 rounded-full blur-2xl" />

                <div className="relative z-10">
                  <h3 className="font-black text-xl text-slate-900 mb-3">{t('contact.connectWithUs')}</h3>
                  <p className="text-slate-600 text-sm mb-6 font-medium">{t('contact.followUsDescription')}</p>
                  ...
                  <div className="mt-6 pt-6 border-t border-slate-200 flex items-center justify-center gap-6 text-xs text-slate-600">
                    <div className="text-center">
                      ...
                      <p className="font-medium">{t('contact.followers')}</p>
                    </div>
                    <div className="w-px h-8 bg-slate-200" />
                    <div className="text-center">
                      <p className="font-black text-xl text-slate-900 mb-1">4.9</p>
                      <p className="font-medium">{t('tour.rating')}</p>
                    </div>
                    <div className="w-px h-8 bg-slate-200" />
                    <div className="text-center">
                      <p className="font-black text-xl text-slate-900 mb-1">500+</p>
                      <p className="font-medium">{t('contact.reviews')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/60 shadow-2xl overflow-hidden">
              {/* Decorative elements */}
              <div className="absolute top-0 end-0 w-64 h-64 bg-gradient-to-br from-red-200/20 to-orange-200/20 rounded-full blur-3xl" />
              <div className="absolute bottom-0 start-0 w-64 h-64 bg-gradient-to-br from-blue-200/20 to-purple-200/20 rounded-full blur-3xl" />
              ...
              <div className="relative z-10">
                <div className="text-center mb-12">
                  ...
                  <p className="text-slate-600 font-medium text-lg">{t('contact.quickAnswers')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                  {[
                    {
                      icon: "⏱️",
                      question: t('contact.faqResponseTime'),
                      answer: t('contact.faqResponseTimeAnswer'),
                      color: "from-blue-500 to-cyan-500"
                    },
                    {
                      icon: "📝",
                      question: t('contact.faqModifyBooking'),
                      answer: t('contact.faqModifyBookingAnswer'),
                      color: "from-purple-500 to-pink-500"
                    },
                    {
                      icon: "👥",
                      question: t('contact.faqGroupDiscounts'),
                      answer: t('contact.faqGroupDiscountsAnswer'),
                      color: "from-green-500 to-emerald-500"
                    },
                    {
                      icon: "💳",
                      question: t('contact.faqPaymentMethods'),
                      answer: t('contact.faqPaymentMethodsAnswer'),
                    ...
                    >
                      ...
                      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all border border-white/60 h-full">
                        ...
                        <p className="text-slate-600 leading-relaxed font-medium ps-16">{faq.answer}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  <p className="text-slate-600 mb-4 font-medium">{t('contact.stillHaveQuestions')}</p>
                  <button
                    onClick={openChatbot}
                  ...
                  >
                    ...
                    <span>{t('contact.chatWithOurTeam')}</span>
                  </button>
                </motion.div>
              </div>
            </div>
