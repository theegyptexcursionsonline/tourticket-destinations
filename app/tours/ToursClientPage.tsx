            ...
            <div className="max-w-2xl mx-auto relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-white/20 shadow-2xl text-base"
                />
                {searchQuery && (
                  <button
