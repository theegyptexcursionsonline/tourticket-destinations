          ...
          <div className="relative group">
            <div className="relative bg-white/95 backdrop-blur-xl rounded-full shadow-xl hover:shadow-2xl border-2 border-blue-300/30 hover:border-blue-400/50 transition-all duration-300">
              <input
                ...
                className="w-full pl-14 md:pl-16 pr-4 py-4 text-sm md:text-base text-gray-900 placeholder:text-gray-400/70 placeholder:font-normal font-medium bg-transparent outline-none rounded-full relative z-10"
              />
