              ...
              {editingSettings?.backgroundImages.map((image, index) => (
                ...
                >
                  <div className="aspect-video relative bg-slate-100">
                    ...
                    {/* Active Badge */}
                    {image.isActive && (
                      <div className="absolute top-3 start-3 bg-green-500 text-white px-2 py-1 rounded-lg text-xs font-semibold flex items-center gap-1">
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="border-t border-slate-200 pt-8">
              ...
              <div className="relative aspect-video bg-slate-100 rounded-xl overflow-hidden border border-slate-200">
                ...
                {/* Animation Indicator */}
                <div className="absolute top-4 end-4 bg-black/50 text-white px-2 py-1 rounded-lg text-xs flex items-center gap-1">
                  {editingSettings.animationSettings.enableAutoplay ? (
                    <>
