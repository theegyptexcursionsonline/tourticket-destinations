...
const StarRating = ({ rating, size = 'sm' }: { rating: number; size?: 'sm' | 'lg' }) => (
  <div className="flex items-center">
    ...
    <span className={`ms-2 ${size === 'lg' ? 'text-lg' : 'text-sm'} font-semibold text-slate-700`}>
      {rating}/5
    </span>
  </div>
);
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-slate-500 pt-4 border-t border-slate-200">
                  <div className="flex flex-wrap items-center gap-4 mb-2 sm:mb-0">
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-gradient-to-br from-slate-400 to-slate-600 rounded-full flex items-center justify-center text-white font-semibold text-xs me-2">
                    ...
                    <div className="flex items-center">
                      <Map className="h-4 w-4 me-2 text-slate-400" />
