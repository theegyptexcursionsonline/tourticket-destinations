            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute end-3 top-1/2 -translate-y-1/2 text-slate-500 font-medium">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-slate-100 to-slate-50 border-b border-slate-200/60">
                  <tr>
                    <th className="px-6 py-4 text-start text-xs font-bold text-slate-600 uppercase tracking-wider">Code</th>
                    <th className="px-6 py-4 text-start text-xs font-bold text-slate-600 uppercase tracking-wider">Value</th>
                    <th className="px-6 py-4 text-start text-xs font-bold text-slate-600 uppercase tracking-wider">Status</th>
