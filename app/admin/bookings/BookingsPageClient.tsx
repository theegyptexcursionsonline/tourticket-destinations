...
const BookingsPage = () => {
  ...
  const fetchBookings = useCallback(async (effectiveSearch: string) => {
    ...
    // Stale-while-revalidate keyed by the exact filter view (tenant included
    // in the URL): revisiting the page paints the last-known rows instantly
    // while the fresh list loads behind it. sessionStorage: per tab, contains
    ...
    return (
      <div className="relative">
        <select
          ...
          disabled={isUpdating}
          className={`appearance-none text-xs font-semibold px-3 py-2 pe-8 rounded-full border-0 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed ${
            (() => {
  ...
  // Cached list views are stale after a mutation — drop them so old rows or
  // statuses can't flash back on the next visit.
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 mb-6">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full h-11 ps-10 pe-4 border border-slate-300 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center text-sm text-slate-900">
                          <Users size={14} className="me-1 text-slate-400" />
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center text-sm font-semibold text-slate-900">
                          <DollarSign size={14} className="me-1 text-green-600" />
